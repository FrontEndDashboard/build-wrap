      ...
      return $.plot($el, [
        ...
        series: {
          lines: {
            ...
            lineWidth: 1,
            fill: true,
            fillColor: EmVars.colors.light.color
          },
          points: {
            radius: 3,
            show: true
        ...
        colors: [EmVars.colors.dark.color],
        xaxis: {},
        yaxis: {
          ticks: 5
        },
...
(function() {
  $(document).on('ready page:load', function() {
    ...
    return $('.daily-line').each(function() {
      var $el, color;
      $el = $(this);
      color = EmVars.colorFromName($el.data('color') || 'info');
      return $.plot($el, [
...
(function() {
  $(document).on('ready page:load', function() {
    ...
    return $(".wait-live").length && (live = $.plot(".wait-live", [getRandomData()], {
      series: {
        lines: {
          show: true,
          lineWidth: 1,
      ...
      grid: {
        tickColor: EmVars.colorFromName('light-dk'),
        borderWidth: 0
      }
    })) && update();
  });
